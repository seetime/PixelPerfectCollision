...
bool HelloWorld::init()
{
    ...
    do 
    {
		...
		CCLabelTTF* pLabel3 = CCLabelTTF::create("Alignment 0\nnew line", CCSizeMake(256, 32), kCCTextAlignmentLeft, "Helvetica", 14);
        CC_BREAK_IF(! pLabel3);
...
void HelloWorld::tick(float delta)
{
    ...
    sprintf(string, "ship rect=(%03.1f,%03.1f)-(%03.1f,%03.1f)", CCRect::CCRectGetMinX(r1), CCRect::CCRectGetMinY(r1), \
												CCRect::CCRectGetMaxX(r1), CCRect::CCRectGetMaxY(r1));
...
HelloWorld::isCollisionBetweenSpriteA(CCSprite* spr1, CCSprite* spr2, bool pp)
{
	...
	intersection = CCRectMake(max(CCRect::CCRectGetMinX(r1),CCRect::CCRectGetMinX(r2)), max(CCRect::CCRectGetMinY(r1),CCRect::CCRectGetMinY(r2)),0,0);
	intersection.size.width = min(CCRect::CCRectGetMaxX(r1), CCRect::CCRectGetMaxX(r2)) - CCRect::CCRectGetMinX(intersection);
	intersection.size.height = min(CCRect::CCRectGetMaxY(r1), CCRect::CCRectGetMaxY(r2)) - CCRect::CCRectGetMinY(intersection);
...
void HelloWorld::ccTouchesMoved(CCSet *pTouches, CCEvent *pEvent)
{
    ...
    m_tBeginPos = touch->locationInView();    
    m_tBeginPos = CCDirector::sharedDirector()->convertToGL( m_tBeginPos );
    m_tEndPos = touch->previousLocationInView();    
