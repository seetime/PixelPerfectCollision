# set params
NDK_ROOT=/cygdrive/c/NVPACK/android-ndk-r8
COCOS2DX_ROOT=/cygdrive/c/Development/cocos2d-2.0-rc2-x-2.0.1
GAME_ROOT=$COCOS2DX_ROOT/test1
...
if [[ $buildexternalsfromsource ]]; then
	...
	echo $NDK_ROOT/ndk-build -C $GAME_ANDROID_ROOT \
